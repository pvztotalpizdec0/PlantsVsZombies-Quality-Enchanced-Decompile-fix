...
const bool			HAS_WIDESCREEN = false;

const int			BOARD_WIDTH = (HAS_WIDESCREEN ? 1066 : 800);
const int			BOARD_HEIGHT = 600;
const int			BOARD_OFFSET_X = 220;
const int			BOARD_ADDITIONAL_WIDTH = (HAS_WIDESCREEN ? 133 : 0);
...
const int			STREET_ZOMBIE_START_X = 1020;
...
const int           STORESCREEN_ITEMOFFSET_2_Y = (HAS_WIDESCREEN ? 313 : 310);
...
//const bool			HAS_WIDESCREEN = true;